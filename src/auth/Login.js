    ...
    <LoginStyles>
      ...
      <div className='login-container'>
        ...
        <div className='login-google' onClick={signInWithGoogle}>
          <img src='https://seeklogo.com/images/G/google-2015-logo-65BBD07B01-seeklogo.com.png' alt='google.png'/>
          <h5>Sign in with google</h5>
        </div>
        <button onClick={signUp} className='signup'>Create your Amazon Account</button>
      </div>
    </LoginStyles>
  )
}
